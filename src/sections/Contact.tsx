        ...
        <div className='bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl relative overflow-hidden z-0'>
          ...
          <div className='flex flex-col md:flex-row items-center md:gap-16 justify-center'>
            <div className=''>
              ...
              <p className='text-sm mt-2 text-center md:text-left md:text-base'>{language === "de" ? "Ready to bring your next Project to Life? Let's connect and discuss how I can help you achieve your goals." : " Lass uns dein nächstes Projekt zum Leben zu erwecken? Tretten wir in Kontakt und besprechen, wie ich dir helfen kann, deine Ziele zu erreichen."}</p>
            </div>
